...
/**
 * Übersicht aller Monatspläne. Ein Klick öffnet den Plan im Detail.
 *
 * Jede Karte zeigt Soll gegen Ist für die drei Budgets. Die Summen kommen
 * fertig vom Backend — die Übersicht lädt nicht alle Posten aller Monate,
 * nur um sie zu addieren.
 */

/** Ab hier ist die Quote gerissen. */
...
function CreatePlanDialog({
  ...
  // Der laufende und die nächsten Jahre — rückwirkend planen ergibt selten Sinn.
